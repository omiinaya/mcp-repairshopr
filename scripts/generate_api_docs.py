...
class RepairShoprDocGenerator:
    ...
    def generate_section_doc(self, section_name: str, endpoints: List[Dict]) -> str:
        ...
        md.append(title)
        md.append("")
        md.append("> **Note:** This file was automatically generated from the RepairShopr API swagger.json.")
        md.append("")
    ...
    def _generate_index(self, sections: Dict[str, List[Dict]]):
        ...
        md.append("")
        md.append("This documentation is automatically generated from the RepairShopr API swagger.json.")
        md.append("")
